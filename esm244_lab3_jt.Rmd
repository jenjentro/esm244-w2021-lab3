...
adelie_chinstrap <- penguins %>%
  ...
  mutate(species = fct_drop(species)) # Drop Gentoo factor level since there are currently no observations
```

Let's just dataviz of those two species:
```{r}
ggplot(adelie_chinstrap,
...
# .fitted = probability of being a Chinstrap penguin
```
